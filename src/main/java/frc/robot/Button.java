...
public class Button {
    ...
    public static Trigger cont1_leftBumper1 = new JoystickButton(controller1, 5);
    public static Trigger cont1_rightBumper1 = new JoystickButton(controller1, 6);
    ...
    public static Trigger cont1_share = new JoystickButton(controller1, 9);
    public static Trigger cont1_options = new JoystickButton(controller1, 10);
    public static Trigger cont1_leftStickClick1 = new JoystickButton(controller1, 11);
    public static Trigger cont1_rightStickClick1 = new JoystickButton(controller1, 12);
